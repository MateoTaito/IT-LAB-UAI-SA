...
import { updateSelectedInstanceRoute } from "../../../../config/selectedInstanceApi";
            ...
            <div className="flex items-center space-x-2">
              ...
              <select
                ...
                onChange={(e) => {
                  ...
                  updateSelectedInstanceRoute(instance?.Route || null);
                }}
              ...
              >
                ...
                {instances.map((instance) => (
                  <option key={instance.Id} value={instance.Id}>
                    {instance.Name} ({instance.InstanceId}) ({instance.Route})
                  </option>
                ))}
              </select>
            </div>
          ...
          <div className="bg-purple-50 p-4 rounded-lg border border-purple-100">
            ...
            {labUtilization && (
              <div className="text-sm text-purple-600 mt-1">
                {labUtilization.currentOccupancy}/{labUtilization.maxCapacity}{" "}
                ocupado
              </div>
            )}
          </div>
          ...
          <div className="bg-orange-50 p-4 rounded-lg border border-orange-100">
            ...
            {labUtilization && (
              <div className="text-sm text-orange-600 mt-1">
                de {Math.floor(labUtilization.maxPossibleMinutes / 60)}h
                posibles
              </div>
            )}
          </div>
